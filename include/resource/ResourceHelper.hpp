...
class ResourceHelper {
	public:
		...
		static Tilemap *getTilemap(u16 area, u16 x, u16 y);
		static Tilemap *getCurrentTilemap() { return s_currentTilemap; }
		static void setCurrentTilemap(Tilemap *currentTilemap) { s_currentTilemap = currentTilemap; }

	private:
		static Map *s_currentMap;
		static Tilemap *s_currentTilemap;
};
